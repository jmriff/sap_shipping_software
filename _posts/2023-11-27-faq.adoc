= Top 15 Questions About SAP Shipping Software for Parcel Carriers
...
<script type="application/ld+json">
   {
      ...
      "mainEntity": [
         ...
         },
         {
            "@type": "Question",
            "about": {"@id": "https://blueharbors.com/xss/#Product"},
            "name": "How seamlessly does it integrate with my existing SAP environment?",
            "acceptedAnswer": {
               "@type": "Answer",
               "about": {"@id": "https://blueharbors.com/xss/#Product"},
               "text": "The Express Shipping Solution is embedded software that integrates seamlessly with your existing SAP environment.  It leverages standard SAP tools, such as the express ship interface (XSI) and the API communication layer."
            }
         },
         {
            "@type": "Question",
            "about": {"@id": "https://blueharbors.com/xss/#Product"},
            "name": "Are there any additional configurations or connectors needed?",
            "acceptedAnswer": {
               "@type": "Answer",
               "about": {"@id": "https://blueharbors.com/xss/#Product"},
               "text": "Standard SAP customizing is used to configuration shipping options and no additional connectors or middleware is required to communicate with the carriers."
            }
         }
      ]
   }
