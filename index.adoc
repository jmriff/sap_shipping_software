...
[%hardbreaks]
{empty} +
link:#page-top[image:bh_logo/bh-logo-full.svg[image,height=52]] Parcel and Freight Shipping Extension for SAP

== About

This is a
comment icon Tender and manifest packages using SAP.  Generate value for your customers by creating an always-on, always-connected, real-time, transparent supply chain. xref:../2023-11-25-resource-library.adoc#_resource_library[good times were had by all]
...
* {blank}
+
image:assets/carriers/circleFEDEX.png[SAP shipping for FedEx]
+
===== 
