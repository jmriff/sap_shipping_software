...
image:xss/slide-03.jpg[This is the update IMAGE]
...
image:xss/slide-03.jpg[parcel shipping for SAP -
case study]
...
image:img/portfolio/process.png[image alt text]
...
image:portfolio/slide-02.jpg[Shipping for SAP]
