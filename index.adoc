...
<div class="bh-image-row">
  <img src="assets/clients/clientMCKESSON.png" alt="Image 1" style="width:25%; height:auto;"/>
  <p>&nbsp;&nbsp;</p>
  <img src="assets/clients/clientHOOKER.png" alt="Image 2" width="25%" height="25%">
  <p>&nbsp;&nbsp;</p>
  <img src="assets/clients/clientFXI.png" alt="Image 3" width="25%" height="25%">
  <p>&nbsp;&nbsp;</p>
  <img src="assets/clients/clientCARPENTER.png" alt="Image 4" width="25%" height="25%">
</div>
+++
