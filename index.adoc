...
[cols="25%, 75%"]
|===
.2+|image:carriers/circleUPS.png[SAP shipping for UPS]
<.>|Ship with UPS… 
...
>.<|Perform Parcel Tracking within SAP. Capture Proof of Delivery (POD) details, including the delivery date and time, and name of person who
signed for package.
|===
+
