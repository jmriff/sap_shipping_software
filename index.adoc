...
.Tender and manifest packages using SAP{nbsp}{nbsp}|{nbsp}{nbsp}Contact info@blueharbors.com
...
+++
<div class="bh-image-row">
  <img src="assets/clients/clientMCKESSON.png" alt="Image 1" width height="25%">{nbsp}{nbsp}
  <img src="assets/clients/clientHOOKER.png" alt="Image 2" width height="25%">{nbsp}{nbsp}
  <img src="assets/clients/clientFXI.png" alt="Image 3" width height="25%">{nbsp}{nbsp}
  <img src="assets/clients/clientCARPENTER.png" alt="Image 4" width height="25%">
</div>
+++
